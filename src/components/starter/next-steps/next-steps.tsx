 ...
 * @LastEditTime: 2023-06-29 15:50:51
    ...
    <div>
      ...
      <div class="container-banner container-purple container-center">
        ...
        <div class={styles.gettingstarted}>
          <div class={styles.intro} dangerouslySetInnerHTML={GETTING_STARTED_STEPS[store.index].message} />
          <span class={styles.hint} dangerouslySetInnerHTML={GETTING_STARTED_STEPS[store.index].hint} />
        </div>
