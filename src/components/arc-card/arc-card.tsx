 ...
 * @LastEditTime: 2023-06-29 16:30:05
  ...
  return (
    <div class="card">
      ...
      <div class="card-right">
        ...
        <p class="card-info">
          <span class="card-info-create-time frist-child">发表于: {props.dateTime} </span>
          <span class="card-info-update-time">更新于: {props.updateTime}</span>
          <span class="card-info-words-count">字数统计: {props?.wordsCount}</span>
        </p>
