 ...
 * @LastEditTime: 2023-06-20 02:44:55
...
export default component$((props: any) => {
  ...
  return (
      <div class="card">
        ...
        <h3 class="card__title cp" onClick$={() => {}}>
          {props.title}
        </h3>
        ...
        <div class="card-labels">
          {props?.labels && props?.labels.map((item: any) => {
            return (
              <span class="cp" key={item?.id}>
                {item?.name}
              </span>
            );
          })}
        ...
        <div class="card__arrow cp" onClick$={() => {}}>
          <svg
